...
second_turtle.penup()
third_turtle.penup()
first_turtle.setx(-290)
second_turtle.setx(-300)
third_turtle.setx(-310)
...
for _ in range(100):
    ...
    first_turtle.right(10)
    second_turtle.right(10)
    third_turtle.right(10)
    first_turtle.left(10)
    second_turtle.left(10)
    third_turtle.left(10)
